...
const products = {
  ...
  "rv-liner-sheet": {
  title: "RV Liner Sheet",
  image: img202,
  description: "RV Liner Sheets are manufactured using 100% certified Galvalume steel composed of 55% Aluminium, 43.4% Zinc, and 1.6% Silicon. This advanced coating technology ensures superior corrosion resistance, high durability, and long-lasting structural performance in demanding environments.\n\nWith a standard width of 1174 mm, these sheets are specifically designed for interior roofing, wall cladding, and industrial shed lining applications. They are available in thickness options ranging from 0.28mm to 0.50mm, providing flexibility based on structural and project requirements.\n\nCustomers can choose from 70 GSM, 150 GSM, and 200 GSM coating options for enhanced protection and extended lifespan. Available in 25+ vibrant colour options along with Glossy and Matte finish variants, RV Liner Sheets combine functionality with a clean and professional finish.\n\nLightweight, easy to install, and low maintenance, RV Liner Sheets are ideal for warehouses, factories, commercial buildings, and large-scale industrial projects requiring durable internal protection and aesthetic consistency."
},
