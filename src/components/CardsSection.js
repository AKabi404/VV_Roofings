  ...
  onClick={(e) =>
    handleNavigate(
      "/product/rv-liner-sheet",
      {
        ...
        description:
          "High-performance 100% certified Galvalume RV Liner Sheets designed for interior roofing and wall cladding applications. Built with 55% Aluminium, 43.4% Zinc, and 1.6% Silicon for superior durability and corrosion resistance."
      },
      e.currentTarget
    )
  }
>
  <div className="card-image">
    <img src={img202} alt="RV Liner Sheet" />
  </div>
  <h3>RV Liner Sheet</h3>
  <p>
